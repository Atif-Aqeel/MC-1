...
public class MainActivity extends AppCompatActivity implements View.OnClickListener  {
    Button a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,abc;
    MediaPlayer ourSong;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abc = (Button) findViewById(R.id.dot);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.dot:
                ...
                // ourSong=MediaPlayer.create(this,R.raw.abc);
                // ourSong.start();
            ...
            default:
                ...
                builder.setTitle("abc");
                factory = LayoutInflater.from(MainActivity.this);
                view = factory.inflate(R.layout.b, null);
                image= (ImageView) view.findViewById(R.id.ai);
                image.setImageResource(R.drawable.abc);
                builder.setView(view);
                builder.setNeutralButton("BACK", null);
